...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      ...
      body: "RHEA — Your Reliable QC Assistant. An AI-powered quality control assistant built on top of DeepSeek Harness. RHEA helps you with code review, testing, debugging, and development workflows.\n\nPowered by advanced language models through OpenRouter, RHEA brings intelligent assistance to your development workflow.",
